...
<head>
    ...
    <title>List</title>
    <%
        MyList myList = (MyList) request.getAttribute("myList");
    %>
    <title><%= myList.getTitle() %></title>
</head>
<body>
    ...
    <ul>
        <%
            for (int i = 0; i < myList.getSize(); i++) {
                Object item = myList.getByIndex(i);
        ...
        %>
            ...
            <li>
                <p><<%= book.getId() %>></p>
                <a href="book.html?id=<%= book.getId() %>" ><%= book.getTitle() %></a>
            </li>
            ...
            <li>
                <p><<%= video.getId() %>></p>
                <a href="video.html?id=<%= video.getId() %>" ><%= video.getTitle() %></a>
            </li>
            ...
            <li>
                <p><<%= myList1.getId() %>></p>
                <a href="list.html?id=<%= myList1.getId() %>" ><%= myList1.getTitle() %></a>
            </li>
        <%
                }
            }
